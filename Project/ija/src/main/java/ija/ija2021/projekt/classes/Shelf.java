...
public class Shelf implements Drawable  {
    ...
    /**
	 * Shelf class represented shleves on map
	 * @param x x coordinate
     * @param y y coordinate
     * @param stopX x coordinate for shelves stop
     * @param stopX y coordinate for shelves stop
     * @param id shelves id
     * @param controller Main controller
     * @param street street on which this shelf is
	 */
